...
При  изменения стоимости порта ничего не проиходит, пробывал команду ```spanning-tree vlan 1 cost 1```, но тоже не помогла.
```
S2#show spanning-tree 
...
------------------- ---- --- --------- -------- --------------------------------
Et0/1               Root FWD 100       128.2    Shr 
Et0/3               Altn BLK 1        128.4    Shr 
```
### Шаг 4:	Удалите изменения стоимости порта.
```
S2(config)#int et0/3
S2(config-if)#no spanning-tree vlan 1 cost 10
```
